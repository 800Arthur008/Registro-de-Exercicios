...
<form method="POST" action="{{ route('exercises.store') }}">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="name" value="{{ old('name') }}" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-[#3E3E3A] dark:bg-[#0a0a0a] p-2" />
    ...
    <div class="mb-4 grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="number" name="duration_minutes" value="{{ old('duration_minutes', 30) }}" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-[#3E3E3A] dark:bg-[#0a0a0a] p-2" />
        ...
        <div>
            ...
            <input type="number" name="calories" value="{{ old('calories', 0) }}" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-[#3E3E3A] dark:bg-[#0a0a0a] p-2" />
    ...
    <div class="mb-4">
        ...
        <input type="date" name="date" value="{{ old('date', date('Y-m-d')) }}" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-[#3E3E3A] dark:bg-[#0a0a0a] p-2" />
    ...
    <div class="mb-4">
        ...
        <textarea name="notes" class="mt-1 block w-full rounded-md border-gray-300 dark:border-[#3E3E3A] dark:bg-[#0a0a0a] p-2">{{ old('notes') }}</textarea>
